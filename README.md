...
Programé consultas analíticas avanzadas (ingresos por pedido, segmentación de clientes top) y desarrollé una función
personalizada (Stored Procedure) para calcular el gasto total acumulado de usuarios.
